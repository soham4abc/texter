...
<div class="container">
  <div class="row">
    <div class="col">
      <img src="./Images/PicsArt_12-11-06.58.40.jpg" style="max-width:20%;" alt="Cinque Terre">
    </div>
  </div>
...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
  <a class="navbar-brand" href="WebHomePage.html">Home</a>
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link" href="WebHomePage.html">Home</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="WebAboutPage.html">About</a>
      </li>    
    </ul>
  </div>  
</nav>
